...
.fitemtitle{text-align:left}#page-mod-assignment-type-uploadsingle-upload.dir-rtl .mdl-left{text-align:right}.path-mod-chat .chat-event .picture,
...
.qnbutton.flagged{background-image:url(image.php?theme=formfactor&image=i%2Fne_red_mark&rev=162)}.path-mod-quiz
...
li{background-image:url(image.php?theme=formfactor&image=userplan%2Ftask-todo&rev=162&component=mod_workshop);background-position:top left;background-repeat:no-repeat;list-style-type:none}.path-mod-workshop .userplan tr.phasetasks
li.completed{background-image:url(image.php?theme=formfactor&image=userplan%2Ftask-done&rev=162&component=mod_workshop)}.path-mod-workshop .userplan tr.phasetasks
li.fail{background-image:url(image.php?theme=formfactor&image=userplan%2Ftask-fail&rev=162&component=mod_workshop)}.path-mod-workshop .userplan tr.phasetasks
li.info{background-image:url(image.php?theme=formfactor&image=userplan%2Ftask-info&rev=162&component=mod_workshop)}.path-mod-workshop .userplan tr.phasetasks
...
0 4px;padding:0px;width:100px;height:20px;position:relative;background:url(image.php?theme=formfactor&image=i%2Fstar-rating&rev=162) top left repeat-x;float:left}#page-blocks-community-communitycourse .star-rating
li{padding:0px;margin:0px;height:20px;width:20px;float:left}#page-blocks-community-communitycourse .star-rating li.current-rating{background:url(image.php?theme=formfactor&image=i%2Fstar-rating&rev=162) left bottom;position:absolute;height:20px;display:block;text-indent: -9000px;z-index:1}#page-blocks-community-communitycourse
...
.tree_item.branch{background-image:url(image.php?theme=formfactor&image=t%2Fexpanded&rev=162);background-position:0 10%;background-repeat:no-repeat}.block_navigation .block_tree
...
.tree_item.emptybranch{background-image:url(image.php?theme=formfactor&image=t%2Fcollapsed_empty&rev=162);background-position:0% 5%;background-repeat:no-repeat}.jsenabled .block_navigation .block_tree .collapsed
ul{display:none}.jsenabled .block_navigation .block_tree .collapsed
.tree_item.branch{background-image:url(image.php?theme=formfactor&image=t%2Fcollapsed&rev=162)}.jsenabled .block_navigation .block_tree
.tree_item.branch.loadingbranch{background-image:url(image.php?theme=formfactor&image=i%2Floading_small&rev=162)}.jsenabled .block_navigation.dock_on_load,
...
.tree_item.emptybranch{background-image:url(image.php?theme=formfactor&image=t%2Fcollapsed_empty_rtl&rev=162);background-position:center right}.jsenabled.dir-rtl .block_navigation .block_tree .collapsed
.tree_item.branch{background-image:url(image.php?theme=formfactor&image=t%2Fcollapsed_rtl&rev=162)}.block_online_users .content .list
...
.tree_item.branch{background-image:url(image.php?theme=formfactor&image=t%2Fexpanded&rev=162);background-position:0 10%;background-repeat:no-repeat}.block_settings .block_tree
.root_node.leaf{padding-left:0px}.block_settings .block_tree
.active_tree_node{font-weight:bold}.jsenabled .block_settings .block_tree
.tree_item.branch{cursor:pointer}.jsenabled .block_settings .block_tree
.tree_item.emptybranch{background-image:url(image.php?theme=formfactor&image=t%2Fcollapsed_empty&rev=162);background-position:0 10%;background-repeat:no-repeat}.jsenabled .block_settings .block_tree .collapsed
ul{display:none}.jsenabled .block_settings .block_tree .collapsed
.tree_item.branch{background-image:url(image.php?theme=formfactor&image=t%2Fcollapsed&rev=162)}.ie6 .block_settings .block_tree
...
.tree_item.emptybranch{background-image:url(image.php?theme=formfactor&image=t%2Fcollapsed_empty_rtl&rev=162);background-position:center right}.jsenabled.dir-rtl .block_settings .block_tree .collapsed
.tree_item.branch{background-image:url(image.php?theme=formfactor&image=t%2Fcollapsed_rtl&rev=162)}.block_tag_flickr .flickr-photos{padding:3px}.block_tag_youtube .youtube-thumb{padding:3px;padding-bottom:0.5em;display:block;float:left}.block_tag_youtube .yt-video-entry
...
.ygtvtn{background:url(image.php?theme=formfactor&image=y%2Ftn&rev=162) 0 0 no-repeat;width:17px;height:22px}.file-picker
.ygtvtm{background:url(image.php?theme=formfactor&image=y%2Ftm&rev=162) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvtmh{background:url(image.php?theme=formfactor&image=y%2Ftmh&rev=162) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvtp{background:url(image.php?theme=formfactor&image=y%2Ftp&rev=162) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvtph{background:url(image.php?theme=formfactor&image=y%2Ftph&rev=162) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvln{background:url(image.php?theme=formfactor&image=y%2Fln&rev=162) 0 0 no-repeat;width:17px;height:22px}.file-picker
.ygtvlm{background:url(image.php?theme=formfactor&image=y%2Flm&rev=162) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvlmh{background:url(image.php?theme=formfactor&image=y%2Flmh&rev=162) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvlp{background:url(image.php?theme=formfactor&image=y%2Flp&rev=162) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvlph{background:url(image.php?theme=formfactor&image=y%2Flph&rev=162) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvloading{background:url(image.php?theme=formfactor&image=y%2Floading&rev=162) 0 0 no-repeat;width:16px;height:22px}.file-picker
.ygtvdepthcell{background:url(image.php?theme=formfactor&image=y%2Fvline&rev=162) 0 0 no-repeat;width:17px;height:22px}.file-picker
...
.smartselect_submenuitem{background-image:url(image.php?theme=formfactor&image=t%2Fcollapsed&rev=162);background-repeat:no-repeat;background-position:100%}.smartselect.spanningmenu
...
.dir-rtl .ygtvcancel,
.dir-rtl .ygtvcancel:hover{width:18px;height:22px;background-image:url(image.php?theme=formfactor&image=yui2-treeview-sprite-rtl&rev=162&component=theme);background-repeat:no-repeat;cursor:pointer}.dir-rtl
...
.mceText{text-align:right}.formtable tbody
...
.ajaxworking{position:absolute;top:0;left:20px;width:20px;height:20px;background:url(image.php?theme=formfactor&image=i%2Fajaxloader&rev=162) no-repeat}.dir-rtl.path-course-view
...
div{display:inline;cursor:pointer}.course_category_tree .category.with_children>.category_label{background-image:url(image.php?theme=formfactor&image=t%2Fexpanded&rev=162);background-repeat:no-repeat}.course_category_tree
...
.course_link{display:block;background-image:url(image.php?theme=formfactor&image=i%2Fcourse&rev=162);background-repeat:no-repeat;padding-left:18px}.course_category_tree .category
...
.category_label{background-image:url(image.php?theme=formfactor&image=t%2Fcollapsed&rev=162)}.jsenabled .course_category_tree .category.with_children.collapsed .subcategories,
...
.category_label{background-image:url(image.php?theme=formfactor&image=t%2Fcollapsed_rtl&rev=162)}.dir-rtl .course_category_tree .category .courses
...
.minicalendar
th{background:url(image.php?theme=formfactor&image=gradient-sb&rev=162&component=theme) repeat-x 0 0}.maincalendar .calendar-controls{padding:10px
...
.environmenttable th,
.forumheaderlist
th{background:#f3f3f3;border-bottom-width:2px}body.pagelayout-popup{background:#fff !important}div.que{border-color:#ddd}a:link,a:visited{color:#bf3503}a.yui3-menu-label, div.yui3-menu-content .yui3-menu-content .yui3-menuitem-content{color:#bf3503 !important}a:hover,a:active{color:#3f5c10}#page-header{background:#333 url(image.php?theme=formfactor&image=header&rev=162&component=theme) 0 0;color:#fff}.path-course-view .course-content .section.main.current,#page-navigation{background:#bf3503}#page-navigation a:link,
...
.headermain{margin:0.85em 0;font-size:2.5em}#page-navigation{margin:0;padding:0
...
a{background:#fff url(image.php?theme=formfactor&image=gradient-sb&rev=162&component=theme) repeat-x 0 0}.tabtree .tabrow0 .tabrow1 li
a{background:none !important}.userinfobox
.content{border-width:2px;background:url(image.php?theme=formfactor&image=gradient-sb&rev=162&component=theme) repeat-x 0 0}.mform
fieldset{border-color:#ddd}.mform
legend{border:1px
solid #ddd;padding:2px
7px;background:url(image.php?theme=formfactor&image=gradient-sb&rev=162&component=theme) repeat-x 0 -25%}#page-footer{margin:25px
0}#page-footer
.logininfo{margin:1em
0}#custommenu{margin:0
50px}#custommenu,div.yui3-menu,div.yui3-menu-content{border:none !important}#custommenu{background:url(image.php?theme=formfactor&image=gradient-sb&rev=162&component=theme) repeat-x 0 30%;padding-top:4px;padding-bottom:4px;border-bottom:1px solid #ccc !important;border-left:1px solid #eee !important;border-right:1px solid #eee !important}a.yui3-menu-label{border:none !important}div.yui3-menu-content .yui3-menu-content{border:1px
solid #ccc !important;border-top:none !important;margin-top:3px;padding:10px}div.yui3-menu-content .yui3-menu-content .yui3-menu-content{border-top:1px solid #ccc !important}div.yui3-menu-content .yui3-menu-content .yui3-menuitem-content, div.yui3-menu-content .yui3-menu-content .yui3-menu-label{padding-top:5px !important}.path-course-view .course-content
.section.main{background:#f5f5f5;border:1px
solid #ddd}#intro,#pageintro{background:#f7f7f7}.path-mod-forum .forumheaderlist
th{background:url(image.php?theme=formfactor&image=gradient-sb&rev=162&component=theme) repeat-x 0 0}.path-mod-forum .forumheaderlist .r1
...
.c0{background:#f5f5f5}.block{border-width:1px 0 0;border-color:#ccc;border-style:solid;background:url(image.php?theme=formfactor&image=gradient-sb&rev=162&component=theme) repeat-x 0 0}.block
